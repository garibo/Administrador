...
$tempDir = __DIR__ . DIRECTORY_SEPARATOR . '../../../../assets/images/avatars';
...
$config->setTempDir('../../../../assets/images/avatars/');
$request = new \Flow\Request();
if (\Flow\Basic::save('../../../../assets/images/avatars/' . "avatarmain", $config, $request)) {
