    ...
    <section id="main-content">
        ...
        <section class="panel" >
                <header class="panel-heading wht-bg" id="verPedido">
                   <h2 class="gen-case">Cambiar nombre de usuario</h2>
                </header>
            ...
            <section class="panel" >
                <div id="contenido">
                    ...
                    <img src="../../assets/images/ayuda/editarnombreusuario1.png" width="65%">
                    <p class="explicacion">Una vez ahi damos solamente escribimos el nuevo nombre de usuario en el campo de texto y damos click en el boton de cambiar nombre de usuario.</p>
                    <img src="../../assets/images/ayuda/editarnombreusuario2.png" width="40%">
                    <br><br><br><br>
                </div>
            </section>
        </section>
