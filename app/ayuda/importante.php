    ...
    <section id="main-content">
        ...
        <section class="panel" >
                <header class="panel-heading wht-bg" id="verPedido">
                   <h2 class="gen-case">Marcar pedido como importante</h2>
                </header>

            <section class="panel" >
                <div id="contenido">
                    <p class="explicacion">Para marcar un pedido como importante lo unico que tenemos que hacer es dar click sobre la estrella y al colorearse de dorado sinifica que esta marcado como importante.</p>
                    <img src="../../assets/images/ayuda/importante.png" width="30%">
                </div>
            </section>
        </section>
