    ...
    <section id="main-content">
        ...
        <section class="panel" >
                <header class="panel-heading wht-bg" id="verPedido">
                   <h2 class="gen-case">Eliminar productos</h2>
                </header>

            <section class="panel" >
                <div id="contenido">
                    <p class="explicacion">Para eliminar productos debemos ir al modulo de productos y dar click sobre el link de editar del correspondiente producto.</p>
                    <img src="../../assets/images/ayuda/editarproductos1.png" width="65%">
                    <p class="explicacion"> Enseguida nos redirigira a otra pagina donde podremos editar alguno de los valores de este producto al terminar solo debemos dar click sobre el boton de Eliminar.</p>
                    <img src="../../assets/images/ayuda/editarproductos2.png" width="65%">
                    <br><br><br><br>
                </div>
            </section>
        </section>
