    ...
    <section id="main-content">
        ...
        <section class="panel" >
                <header class="panel-heading wht-bg" id="verPedido">
                   <h2 class="gen-case">Cambiar contraseña</h2>
                </header>

            <section class="panel" >
                <div id="contenido">
                    <p class="explicacion">Para editar el nombre de usuario tenemos que ir almodulo de ajustes y buscar la seccion de editar nombre de usuario.<p>
                    <img src="../../assets/images/ayuda/editarcontrasena1.png" width="65%">
                    <p class="explicacion">Una vez ahi escribimos la contraeña actual en el primer campo, en el segundo campo la nueva contraseña y en el tercer campo repetimos la nueva contraseña y damos click en el boton de cambiar contraseña.</p>
                    <img src="../../assets/images/ayuda/editarcontrasena2.png" width="40%">
                    <br><br><br><br>
                </div>
            </section>
        </section>
