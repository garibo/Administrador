    ...
    <section id="main-content">
        ...
        <section class="panel" >
                <header class="panel-heading wht-bg" id="verPedido">
                   <h2 class="gen-case">Modificar precios de pizzas</h2>
                </header>

            <section class="panel" >
                <div id="contenido">
                    <p class="explicacion">Para editar los precios de las pizzas tenemos que ir al modulo de ajustes y posicionarnos sobre la seccion de configurar precios de pizzas.<p>
                    <img src="../../assets/images/ayuda/editarpizzas1.png" width="65%">
                    <p class="explicacion">Una vez ahi damos click sobre el precio que dessemos editar y se nos abrira una ventana con un campo de texto, escribimos el nuevo valor y presionamos el boton de guardar cambios.</p>
                    <img src="../../assets/images/ayuda/editarpizzas2.png" width="65%">
                    <br><br><br><br>
                </div>
            </section>
        </section>
