...
<!--sidebar end-->
    ...
    <section id="main-content">
        ...
        <section class="panel" >
            ...
            <section class="panel" >
                <div id="contenido">
                    <p class="explicacion">Para ver un pedido solo vasta con ir al modulo de pedidos y dar click sobre uno de los elementos de la lista.</p>
                    <img src="../../assets/images/ayuda/inbox.png" width="50%">
                    <p class="explicacion">Enseguida se nos abrira una pagina que contiene todos los elementos y caracteristicas de dicho pedido.</p>
                    <img src="../../assets/images/ayuda/vista.png" width="50%">
                </div>
            </section>
        </section>
