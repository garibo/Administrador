    ...
    <section id="main-content">
        ...
        <section class="panel" >
                <header class="panel-heading wht-bg" id="verPedido">
                   <h2 class="gen-case">Ver pedidos</h2>
                </header>

            <section class="panel" >
                <div id="contenido">
                    <p class="explicacion">Para ver los pedidos de un cliente en particular tenemos que ir al modulo de clientes y dar click sobre el link info del cliente correspondiente.</p>
                    <img src="../../assets/images/ayuda/verclientes1.png" width="65%">
                    <p class="explicacion"> Enseguida nos redirigira a otra pagina donde podremos ver de forma general todos los pedidos que ha realizado dicho cliente.</p>
                    <img src="../../assets/images/ayuda/verclientes2.png" width="65%">
                    <br><br><br><br>
                </div>
            </section>
        </section>
