    ...
    <section id="main-content">
        ...
        <section class="panel" >
                <header class="panel-heading wht-bg" id="verPedido">
                   <h2 class="gen-case">Contestar pedidos</h2>
                </header>

            <section class="panel" >
                <div id="contenido">
                    <p class="explicacion">Para contestar un pedido tenemos que ir al modulo de pedidos, abrir el pedido que deseemos contestar y dar click sobre el boton de contestar.</p>
                    <img src="../../assets/images/ayuda/contestar1.png" width="40%">
                    <p class="explicacion">Enseguida se nos abrira una pagina que contiene un formulario lo unico que tenemos que hacer es editar el texto adentro de de las llaves y dar click sobre el boton enviar.</p>
                    <img src="../../assets/images/ayuda/contestar2.png" width="50%">
                </div>
            </section>
        </section>
