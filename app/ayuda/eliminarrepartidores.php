    ...
    <section id="main-content">
        ...
        <section class="panel" >
                <header class="panel-heading wht-bg" id="verPedido">
                   <h2 class="gen-case">Eliminar repartidores</h2>
                </header>

            <section class="panel" >
                <div id="contenido">
                    <p class="explicacion">Para editar informacion de los repartidores  debemos ir al modulo de repartidores y una vez hai dar click sobre el link editar del respectivo registro.<p>
                    <img src="../../assets/images/ayuda/agregarrepartidores1.png" width="65%">
                    <p class="explicacion"> Enseguida nos redirigira a otra pagina donde se encontrara un formulario con los valores de ese registro una vez ahi damos click en Eliminar.</p>
